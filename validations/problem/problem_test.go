...
func (p TestProblemParams) GetDemand() []int { return p.Demand }

//GetSupply method for interface
func (p TestProblemParams) GetSupply() []int { return p.Supply }

//GetCosts method for interface
func (p TestProblemParams) GetCosts() [][]float64 { return p.Costs }
func TestIsValidParams(t *testing.T) {
	params := TestProblemParams{
